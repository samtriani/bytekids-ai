...
export class StudentsComponent {
  ...
  all = [
    {n:'Sofía Ramírez',  av:'SR', cls:'4°A', prog:92, xp:1890, streak:22, status:'Excelente',      last:'Hoy',        subjects:['Python','HTML/CSS'], nextMission:'Funciones avanzadas'},
    {n:'Emilio Torres',  av:'ET', cls:'4°A', prog:88, xp:1600, streak:18, status:'Excelente',      last:'Hoy',        subjects:['Python','Scratch'],   nextMission:'POO básica'},
    {n:'Axel Partida',   av:'AP', cls:'4°A', prog:78, xp:1250, streak:12, status:'Regular',        last:'Hoy',        subjects:['Python','HTML/CSS'],  nextMission:'Condicionales IF/ELSE'},
    {n:'Valentina Cruz', av:'VC', cls:'4°A', prog:67, xp:980,  streak:7,  status:'Regular',        last:'Ayer',       subjects:['Scratch','HTML/CSS'], nextMission:'Variables y tipos'},
    {n:'Mariana López',  av:'ML', cls:'4°A', prog:53, xp:840,  streak:4,  status:'Regular',        last:'Hoy',        subjects:['Scratch'],           nextMission:'Primeros bucles'},
    {n:'Carlos Mendez',  av:'CM', cls:'4°A', prog:42, xp:720,  streak:0,  status:'Necesita apoyo', last:'Hace 5 días', subjects:['Scratch'],           nextMission:'Módulo 1 incompleto'},
  ];
