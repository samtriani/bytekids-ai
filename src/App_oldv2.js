                    ...
                    <tr key={student.id} className="hover:bg-violet-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="flex gap-2">
                          <button 
                            onClick={() => alert(`Ver detalles de ${student.name}`)}
                          ...
                          <button 
                            onClick={() => alert(`Editar ${student.name}`)}
      ...
      <Modal isOpen={!!selectedTeacher} onClose={() => setSelectedTeacher(null)} title={`Detalles: ${selectedTeacher?.name}`}>
        {selectedTeacher && (
          <div className="space-y-4">
            ...
            <button
              onClick={() => alert(`Enviando mensaje a ${selectedTeacher.name}...`)}
...
const TeacherDashboard = ({ onLogout, appState }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard icon={Users} label="Estudiantes Activos" value={24} trend={12} color="violet" onClick={() => alert('Ver lista completa de estudiantes')} />
          <StatCard icon={BookOpen} label="Clases Esta Semana" value={8} color="orange" onClick={() => alert('Ver calendario de clases')} />
          <StatCard icon={TrendingUp} label="Promedio Grupal" value={87} trend={5} color="blue" onClick={() => alert('Ver reporte detallado')} />
          <StatCard icon={Award} label="Badges Ganados" value={156} trend={23} color="green" onClick={() => alert('Ver todos los logros')} />
        </div>
        ...
        {selectedStudent && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                onClick={() => alert(`Enviando mensaje a ${selectedStudent.name}...`)}
      ...
      {/* Modal Chat IA */}
      <Modal isOpen={showAIChat} onClose={() => setShowAIChat(false)} title="Asistente IA - CodeMaster Pro">
        <div className="space-y-4">
          <div className="bg-violet-50 rounded-xl p-4 border border-violet-200">
            <p className="text-sm text-violet-900">
              💡 <strong>Sugerencia:</strong> Pedro necesita un ejercicio más simple. ¿Genero uno sobre variables básicas?
            </p>
          </div>
          <button
            onClick={() => {
            ...
            className="w-full px-4 py-3 bg-violet-600 hover:bg-violet-700 text-white rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors"
          >
            <Sparkles className="w-5 h-5" />
            Generar Ejercicio Ahora
          </button>
        </div>
      </Modal>
    </div>
...
const StudentDashboard = ({ onLogout }) => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, {
        id: prev.length + 1,
        role: 'assistant',
        content: '¡Excelente pregunta! Los loops son como practicar tiros 10 veces seguidas. ¿Quieres intentar hacer un loop que imprima "Gol!" 5 veces? 🎯'
      }]);
    }, 1000);
    setInputMessage('');
  };
  ...
  const handleStartMission = (index) => {
    if (index === 0) {
      alert('¡Perfecto! Comienza con el ejercicio de código de abajo 👇');
    } else if (index === 1) {
      alert('🎮 Los proyectos estarán disponibles próximamente. Por ahora, practica con los ejercicios.');
    } else {
      alert('💬 ¡El chat con AI Tutor está justo abajo! Comienza a hacer preguntas.');
    }
  };
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 mb-4">
                  ...
                  <button
                    onClick={() => alert('💡 Pista: Usa un loop for con range(5) y print("Gol!")')}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl shadow-xl p-6 text-white">
              ...
              <button 
                onClick={() => alert('🎥 Conectando a clase en vivo...')}
...
const ParentDashboard = ({ onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard icon={TrendingUp} label="Promedio General" value={childData.averageGrade} color="green" onClick={() => alert('Ver reporte detallado')} />
          <StatCard icon={Calendar} label="Asistencia" value={`${childData.attendance}%`} color="blue" onClick={() => alert('Ver historial de asistencia')} />
          <StatCard icon={CheckCircle} label="Tareas Completas" value={18} color="violet" onClick={() => alert('Ver todas las tareas')} />
          <StatCard icon={Flame} label="Racha de Días" value={childData.streak} color="orange" onClick={() => alert('Ver calendario de práctica')} />
        </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-xl p-8 border-2 border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <button 
                    onClick={() => alert('📨 Abriendo chat con el maestro...')}
